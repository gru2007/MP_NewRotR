...
force ace_medical_blood_bloodLifetime = 59;
...
force ace_medical_spontaneousWakeUpChance = 0.6;
...
force ace_medical_treatment_cprSuccessChance = 0.701618;
...
force acex_field_rations_hungerSatiated = 4;
force acex_field_rations_terrainObjectActions = true;
force acex_field_rations_thirstQuenched = 4.98637;
force acex_field_rations_timeWithoutFood = 100;
force acex_field_rations_timeWithoutWater = 80;
...
Achilles_var_125_ac = true;
Achilles_var_212_Clone_Base = true;
Achilles_var_212_fc = true;
Achilles_var_212th_clone_faction = true;
Achilles_var_212th_other_clone_faction = true;
Achilles_var_212th_Props_F = true;
Achilles_var_212th_Sturctures_F = true;
Achilles_var_442_CIS = true;
Achilles_var_442_CIS_desert = true;
Achilles_var_442_CIS_secruity = true;
Achilles_var_442_CIS_winter = true;
Achilles_var_442_CIS_woodland = true;
Achilles_var_44_ab = true;
Achilles_var_9_ac = true;
Achilles_var_B_212infantry = true;
Achilles_var_B_SCI212thAB = true;
Achilles_var_Bandits = true;
Achilles_var_black_legion = true;
...
Achilles_var_C_I_S = true;
Achilles_var_CIV_F = true;
Achilles_var_CIV_IDAP_F = true;
Achilles_var_DeathWatch = true;
Achilles_var_EMPIRE = true;
Achilles_var_EMPIRE_B = true;
Achilles_var_FIRSTORDER = true;
Achilles_var_GALACTIC_REPUBLIC = true;
Achilles_var_Geonosians = true;
...
Achilles_var_JEDIORDER = true;
Achilles_var_JMM_formorGuard_b_faction = true;
Achilles_var_JMM_formorMilitia_b_faction = true;
Achilles_var_JMM_infected_o_faction = true;
Achilles_var_JMM_OX01_o_faction = true;
Achilles_var_kobra_b = true;
Achilles_var_kobra_c = true;
Achilles_var_kobra_i = true;
Achilles_var_kobra_o = true;
Achilles_var_LS_CIS = true;
Achilles_var_LS_CSF = true;
Achilles_var_LS_GAR = true;
Achilles_var_LS_MANDALORIAN = true;
Achilles_var_LS_ORSF = true;
Achilles_var_LS_REPNAVY = true;
Achilles_var_LS_SOB = true;
Achilles_var_Mandalorians = true;
Achilles_var_MEOP_asari = true;
Achilles_var_MEOP_batarian = true;
Achilles_var_MEOP_BloodP = true;
Achilles_var_MEOP_BS = true;
Achilles_var_MEOP_cerber = true;
Achilles_var_MEOP_civil = true;
Achilles_var_MEOP_council = true;
Achilles_var_MEOP_Eclipse = true;
Achilles_var_MEOP_geth = true;
Achilles_var_MEOP_human = true;
Achilles_var_MEOP_humanI = true;
Achilles_var_MEOP_Krogs = true;
Achilles_var_MEOP_merc = true;
Achilles_var_MEOP_mercB = true;
Achilles_var_MEOP_mercR = true;
Achilles_var_MEOP_prothean = true;
Achilles_var_MEOP_Quar = true;
Achilles_var_MEOP_reaper = true;
Achilles_var_MEOP_salarians = true;
Achilles_var_MEOP_turians = true;
Achilles_var_MEOP_turiansI = true;
Achilles_var_Mercenaries = true;
Achilles_var_O_3AS_CISV1 = true;
Achilles_var_O_3AS_CISV2 = true;
Achilles_var_O_3AS_CISV3 = true;
Achilles_var_O_CIS_HumanDivision = true;
Achilles_var_O_CISHumanDivision = true;
Achilles_var_O_Kalani = true;
...
Achilles_var_OPTRE_CAA = true;
Achilles_var_OPTRE_Ins = true;
Achilles_var_OPTRE_PD = true;
Achilles_var_OPTRE_UEG_Civ = true;
Achilles_var_OPTRE_UNSC = true;
Achilles_var_Prop = true;
Achilles_var_RD501_CIS_Faction = true;
Achilles_var_RD501_Civ_Faction = true;
Achilles_var_RD501_Empire_Faction = true;
Achilles_var_RD501_First_Order = true;
Achilles_var_RD501_Independent_Faction = true;
Achilles_var_RD501_Rebel_Faction = true;
Achilles_var_RD501_Republic_Faction = true;
Achilles_var_RD501_Resistance_Faction = true;
Achilles_var_REBELLION = true;
Achilles_var_Ryanzombiesfaction = true;
Achilles_var_Ryanzombiesfactionmodule = true;
Achilles_var_Ryanzombiesfactionopfor = true;
Achilles_var_separatist_o_faction = true;
Achilles_var_SITHORDER = true;
Achilles_var_SKX_Clones_faction = true;
Achilles_var_SKX_Hell = true;
Achilles_var_SWLB_GAR = true;
Achilles_var_SWLB_GAR_SOB = true;
Achilles_var_SWRESISTANCE = true;
Achilles_var_TuskenRaiders = true;
Achilles_var_Virtual_F = true;
Achilles_var_Wookies = true;
...
Achilles_var_Ares_Module_Zeus_Destroy = true;
Achilles_var_Ares_Module_Zeus_Hint = true;
Achilles_var_Ares_Module_Zeus_Laser = true;
...
achilles_curator_vision_whitehot = false;
...
RD501_MedNotif_Message = "%1 осматривает вас и просит не двигаться.";
