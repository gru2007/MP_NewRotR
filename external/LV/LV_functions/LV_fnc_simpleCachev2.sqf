...
initial version by SPUn / lostvar
	...
	nul = [[script parameter list],[players],distance,keep count,MP] execVM "external\LV\LV_functions\LV_fnc_simpleCache.sqf";
	...
	nul = [[[1, [parameter for 1]], [2, [parameter for 2]]],[playerUnit1],500,true,false] execVM "external\LV\LV_functions\LV_fnc_simpleCache.sqf";

*/
if (!isServer)exitWith{};
if(isNil("LV_fnc_removeGroupv2"))then{LV_fnc_removeGroupv2 = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_removeGroupv2.sqf";};
...
if(_mp)then{if(isNil{LV_GetPlayers})then{LV_GetPlayers = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_getPlayers.sqf"; waitUntil {!isNil{LV_GetPlayers}};};};

if(isNil("LV_militarize"))then{LV_militarize = compileFinal preprocessFile "external\LV\militarize.sqf";};
if(isNil("LV_fillHouse"))then{LV_fillHouse = compileFinal preprocessFile "external\LV\fillHouse.sqf";};
