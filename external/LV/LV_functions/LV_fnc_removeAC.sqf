...
//Syntax: nul = [handle,style,syncedUnit,range/delay,flee direction] execVM "external\LV\LV_functions\LV_fnc_removeAC.sqf";
//*handle = the name of ambientCombat, ex: war = [this] execVM "external\LV\ambientCombat.sqf"; <-war is the handle
...
LV_deleteOnDestination = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_deleteOnDestination.sqf";
LV_killAfterDelay = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_killAfterDelay.sqf";
