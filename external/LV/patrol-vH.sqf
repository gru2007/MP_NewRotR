...
//
//*simple water patrol
//*Syntax: nul = [this] execVM "external\LV\patrol-vE.sqf";
//     or: nul = [this,center] execVM "external\LV\patrol-vE.sqf";
...
while{_run}do{
    ...
    waitUntil {sleep 0.011;((unitReady _unit)||(_unit distance _pos)<30)};
