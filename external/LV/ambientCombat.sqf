/*
		...
		Calling the script:
				...
				default: 	nul = [] execVM "external\LV\ambientCombat.sqf";
				custom: 	nul = [min range, max range, min delay, max delay, groups, side ratios, center unit, vehicle chance,
								...
								patrol type, MP, clean, classes] execVM "external\LV\ambientCombat.sqf";
	...
	Parameters:
		...
		Fully customized example:
				nul = [150,600,10,30,8,[0,1,1],player,50,10,false,[0.2,0.3,0.1,0.55,0.25,1,1,0.25,1,1],true,800,"hint format['spawning unit: %1',this];",
					["AWARE","SAD"],false,true,["ALL"]] execVM "external\LV\ambientCombat.sqf";
...
if(isNil("LV_fullLandVehicle"))then{LV_fullLandVehicle = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_fullLandVehicle.sqf";};
if(isNil("LV_fullAirVehicle"))then{LV_fullAirVehicle = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_fullAirVehicle.sqf";};
if(isNil("LV_fullWaterVehicle"))then{LV_fullWaterVehicle = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_fullWaterVehicle.sqf";};
if(isNil("LV_menGroup"))then{LV_menGroup = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_menGroup.sqf";};
if(isNil("LV_diveGroup"))then{LV_diveGroup = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_diveGroup.sqf";};
if(isNil("LV_ACpatrol"))then{LV_ACpatrol = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_ACpatrol.sqf";};
if(isNil("LV_ACcleanUp"))then{LV_ACcleanUp = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_ACcleanUp.sqf";};
if(isNil("LV_ACskills"))then{LV_ACskills = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_ACskills.sqf";};
if(_communication)then{if(isNil("LV_AIcommunication"))then{LV_AIcommunication = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_AIcommunication.sqf";};};
if(isNil("LV_vehicleInit"))then{LV_vehicleInit = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_vehicleInit.sqf";};
if(isNil("LV_RandomSpot"))then{LV_RandomSpot = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_randomSpot.sqf";};
...
if(isNil("LV_FindLandPosition"))then{LV_FindLandPosition = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_findLandPosition.sqf";};
if(isNil("LV_IsInMarker"))then{LV_IsInMarker = compileFinal preprocessFile "external\LV\LV_functions\LV_fnc_isInMarker.sqf";};
