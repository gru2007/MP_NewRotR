/*
		...
		Calling the script:
			...
			default: 		nul = [this] execVM "external\LV\reinforcementChopper.sqf";
			custom: 		nul = [spot,exact,side,type,captive,patrol,target,direction,distance,precise,
								cycle,groupSize,skills,smoke,group,custom init,ID,MP,doors,classes] execVM "external\LV\reinforcementChopper.sqf";
	...
	EXAMPLE: 	nul = [player,false,2,3,false,true,player,"random",1000,true,false,8,0.75,[false,true,false,true],nil,nil,33,false,false,["ALL"]] execVM "external\LV\reinforcementChopper.sqf";
*/
